...
number: 1
name: DataPoints in Methodology Sidebar
expected: |
  Open the insights page and select a campaign row. Open the Methodology Sidebar. The "Data Points" field should display a numeric value (e.g., 90, 365) — not "undefined" or blank. No console errors.
