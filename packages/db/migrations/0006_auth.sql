...
-- NOTE: No RLS on auth tables (Pitfall 6 — Better Auth operates outside tenant context during auth flows).
-- Tenant data isolation is enforced at the application layer via session.user.tenantId.
